...
export default function ProductDevelopment() {
    ...
    const services = [
        {
            ...
            // items: ['Design Evaluation', 'Design Strategy Development', 'Stakeholder & User Workshops', 'Reports & Recommendations']
        },
        {
            thumb: design,
            title: "Mobile UI/UX",
            ...
            // items: ['Wireframes & Pixel-Perfect Mockups', 'Rapid Prototyping', 'Visual Design', 'Analysis']
        },
        {
            thumb: system,
            title: "Motion Design",
            ...
            // items: ['UI Kit & Style Guide Development', 'Pattern Library', 'Component Documentation', 'Version Control']
        },
        {
            thumb: research,
            ...
            // items: ['User Interviews & Surveys', 'Usability Testing', 'Heatmaps & Click Tracking', 'A/B Testing']
        },
    ];
    ...
    return(
        <>
            <title>Product Development Services Israel | ReddenSoft Israel</title>
            <meta name="title" content="Product Development Services Israel | ReddenSoft Israel" />
            <meta name="description" content="Get expert Product Development Services in Israel. We specialize in software product development, creating innovative and scalable solutions for your business." />
            ...
            <div className="banner_bg h-[250px] md:h-[250px] xl:h-[450px] flex flex-col items-center justify-center px-5 2xl:px-0">
                <div className="max-w-[700px] lg:max-w-[990px] xl:max-w-[1200px] 2xl:max-w-[1420px] w-full mx-auto text-white text-center relative z-2">
                    <div className="text-2xl md:text-4xl lg:text-5xl font-black 2xl:leading-[60px]">Product Development Services in</div>
